...
class ErgonomicFatigue extends StatefulWidget {
  @override
  _ErgonomicFatiguePageState createState() => _ErgonomicFatiguePageState();
}

class _ErgonomicFatiguePageState extends State<ErgonomicFatigue> {
  // List of procedures and instructions
  final List<String> procedures = [
    
    'Safe position/movement for task',
  ];

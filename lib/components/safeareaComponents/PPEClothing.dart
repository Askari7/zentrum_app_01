...
class PPEClothing extends StatefulWidget {
  @override
  _PPEClothingPageState createState() => _PPEClothingPageState();
}

class _PPEClothingPageState extends State<PPEClothing> {
  // List of procedures and instructions
  final List<String> procedures = [
    
    'Wearing clothing and hair in a safe way',
  ];

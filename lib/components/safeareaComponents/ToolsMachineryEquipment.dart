...
class ToolsMachineryEquipment extends StatefulWidget {
  @override
  _ToolsMachineryEquipmentPageState createState() => _ToolsMachineryEquipmentPageState();
}

class _ToolsMachineryEquipmentPageState extends State<ToolsMachineryEquipment> {
  // List of procedures and instructions
  final List<String> procedures = [
    
    'Proper use of tools/equipment/device',
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Tools, Machinery, Equipment',

...
class TrainingFit extends StatefulWidget {
  @override
  _TrainingFitPageState createState() => _TrainingFitPageState();
}

class _TrainingFitPageState extends State<TrainingFit> {
  // List of procedures and instructions
  final List<String> procedures = [
    
    'Performing activity with authorization and training up to date',
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Training/Fit for Work',
